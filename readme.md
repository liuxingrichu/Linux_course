...
5. 磁盘和文件管理
	1. 磁盘管理
		...
		5. [快速格式化、低级格式化、物理消磁或销毁](chapter_05/day004.md)
...
7. 网络管理
	...
	6. [vmware centos7配置虚拟机NAT连接上网](chapter_07/day05.md)
	7. [IP的分级](chapter_07/day06.md)
	...
	18. [ping通8.8.8.8，不通百度](chapter_07/day17.md)
	4. [排除网络故障]()
8. 自动化
